 ...
 */
package com.techedgegroup.matrix.core.constants;

/**
 * Global class for all MatrixCore constants. You can add global constants for your extension into this class.
 */
public final class MatrixCoreConstants extends GeneratedMatrixCoreConstants
{
	public static final String EXTENSIONNAME = "matrixcore";


	private MatrixCoreConstants()
	{
		//empty
	}
