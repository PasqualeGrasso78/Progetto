 ...
 */
package com.techedgegroup.matrix.fulfilmentprocess.test.jobs;
...
import com.techedgegroup.matrix.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = MatrixFulfilmentProcessConstants.ORDER_PROCESS_NAME;
