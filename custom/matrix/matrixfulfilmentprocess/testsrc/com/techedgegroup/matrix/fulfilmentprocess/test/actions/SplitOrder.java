 ...
 */
package com.techedgegroup.matrix.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(MatrixFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MatrixFulfilmentProcessConstants.PARENT_PROCESS);
