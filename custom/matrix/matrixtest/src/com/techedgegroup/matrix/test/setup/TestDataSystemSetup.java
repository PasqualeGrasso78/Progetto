 ...
 */
package com.techedgegroup.matrix.test.setup;
...
import com.techedgegroup.matrix.test.constants.MatrixTestConstants;
import com.techedgegroup.matrix.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MatrixTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/matrixtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/matrixtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/matrixtest/import/cstickets.impex");
			...
			importImpexFile(context, "/matrixtest/import/csquotes.impex");
		}
	}
}
