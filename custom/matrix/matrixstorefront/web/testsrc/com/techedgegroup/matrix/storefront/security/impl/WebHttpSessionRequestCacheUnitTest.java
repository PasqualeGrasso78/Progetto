...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/matrixstorefront/electronics/en",
						"https://electronics.local:9002/matrixstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/matrixstorefront/electronics/en",
						"https://electronics.local:9002/matrixstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/matrixstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/matrixstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/matrixstorefront/electronics/en",
						"https://electronics.local:9002/matrixstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/matrixstorefront",
						"https://electronics.local:9002/matrixstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/matrixstorefront",
						"https://electronics.local:9002/matrixstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/matrixstorefront/electronics/en",
						"https://electronics.local:9002/matrixstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
